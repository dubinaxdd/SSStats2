...
public:
    explicit GamePanel(GameController* soulstormController, SettingsController* settingsController, QObject *parent = nullptr);
...
public slots:
    ...
    void onGameStopped();
    void onGameStarted(GameMissionState gameCurrentState);
