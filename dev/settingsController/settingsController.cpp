...
void SettingsController::initializeSettings()
{
    ...
    m_settings->transparentCameraTrapezoidInstalled = dow_stats_settings->value("mods/transparent_camera_trapezoid_installed", false).toBool();
...
void SettingsController::saveSettings()
{
    ...
    dow_stats_settings->setValue("mods/transparent_camera_trapezoid_installed", m_settings->transparentCameraTrapezoidInstalled);
